...
**Version:** 0.3.0
**Date:** 2026-04-11
**Repo:** 9 crates, 697 tests, hardening-stage reference runtime with optional p2p alpha
...
2. **Replay-authoritative state** — Blocks, metadata, encrypted validator keys, and periodic snapshots persist across restarts; an optional redb-backed trie mirror exists, but replay remains authoritative
